package com.example.anthonyliberatore.doordashlite.domain.usecase
...
import com.example.anthonyliberatore.doordashlite.domain.usecase.GetRestaurantListUseCase.Result.Failure
import com.example.anthonyliberatore.doordashlite.domain.usecase.GetRestaurantListUseCase.Result.Loading
import com.example.anthonyliberatore.doordashlite.domain.usecase.GetRestaurantListUseCase.Result.Success
